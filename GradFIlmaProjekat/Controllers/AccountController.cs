...
namespace WebApplication3.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(GradFilmaModel.Korisnik model, string returnUrl)
        {
...
=======
            ...
            var result = await SignInManager.PasswordSignInAsync(model.Username, model.ConfirmPassword,false, shouldLockout: false);
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal(returnUrl);
...
>>>>>>> origin/master
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(GradFilmaModel.Korisnik model)
        {
            if (ModelState.IsValid)
            {
<<<<<<< HEAD
